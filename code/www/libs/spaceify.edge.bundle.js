...
})(this, function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_32__, __WEBPACK_EXTERNAL_MODULE_54__, __WEBPACK_EXTERNAL_MODULE_55__, __WEBPACK_EXTERNAL_MODULE_56__, __WEBPACK_EXTERNAL_MODULE_57__, __WEBPACK_EXTERNAL_MODULE_58__, __WEBPACK_EXTERNAL_MODULE_59__, __WEBPACK_EXTERNAL_MODULE_60__, __WEBPACK_EXTERNAL_MODULE_61__, __WEBPACK_EXTERNAL_MODULE_62__, __WEBPACK_EXTERNAL_MODULE_63__) {
...
if (isNodeJs)
	...
	Service = __webpack_require__(46)(lib + "service");
	SpaceifyCore = __webpack_require__(27)(lib + "spaceifycore");
	SpaceifyError = __webpack_require__(28)(lib + "spaceifyerror");
	WebSocketRpcServer = __webpack_require__(50)(lib + "websocketrpcserver");
	SpaceifyConfig = __webpack_require__(2)(lib + "spaceifyconfig");
	SpaceifyNetwork = __webpack_require__(47)(lib + "spaceifynetwork");
...
Logger.getLogger = function(class_, override_)
	...
	if(typeof window === "undefined")
		...
		if(Logger.ifFileExists(__dirname + "/loggerconfig.js"))
			...
			LoggerConfig = __webpack_require__(45)(apipath + "loggerconfig.js");
		}
	else if(typeof window !== "undefined")
		{
		lib = (window.spe ? window.spe : window);
...
if (isNodeJs)
	...
	global.os = __webpack_require__(60);
	global.fs = __webpack_require__(0);
	global.path = __webpack_require__(61);
	global.mkdirp = __webpack_require__(58);
	global.AdmZip = __webpack_require__(54);
	global.request = __webpack_require__(62);
	global.spawn = __webpack_require__(55).spawn;
	}
else
	{
	lib = (window.spe ? window.spe : window);
...
if (isNodeJs)
	...
	//SpaceifyConfig = require(lib + "spaceifyconfig");
	RpcCommunicator = __webpack_require__(9)(lib + "rpccommunicator");
	WebSocketServer = __webpack_require__(53)(lib + "websocketserver");
	}
else
	{
	lib = (window.spe ? window.spe : window);
...
if (isNodeJs)
	...
	global.fs = __webpack_require__(0);
	global.URL = __webpack_require__(63);
	global.http = __webpack_require__(56);
	global.https = __webpack_require__(57);
...
if(isNodeJs)
	...
	SpaceifyConfig = __webpack_require__(2)(lib + "spaceifyconfig");
	SpaceifyUtility = __webpack_require__(8)(lib + "spaceifyutility");
	SpaceifyService = __webpack_require__(48)(lib + "spaceifyservice");
	fibrous = !(function webpackMissingModule() { var e = new Error("Cannot find module \".\""); e.code = 'MODULE_NOT_FOUND';; throw e; }());
	}
else
	{
...
SpaceifyApp: __webpack_require__(33)
};
