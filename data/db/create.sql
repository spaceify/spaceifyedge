CREATE TABLE applications(unique_name TEXT NOT NULL PRIMARY KEY, docker_image_id TEXT, type TEXT, version TEXT, inject_identifier TEXT DEFAULT NULL, install_datetime TEXT, inject_enabled INTEGER DEFAULT 0, position INTEGER DEFAULT 0, develop INTEGER DEFAULT 0);
...
INSERT INTO information VALUES(9, 'Alpha Centauri', '0.8.1', 'ubuntu');
